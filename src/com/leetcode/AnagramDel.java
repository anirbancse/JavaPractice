...
public class AnagramDel {
  ...
  public static int makeAnagram(String first, String second) {
    ...
    /**
     * insertion of map and copture the count for each character
     */
    ...
    /**
     * deletion of repeated characters and also update the value
     */
  ...
  public static void main(String[] args) {
    ...
    System.out.println(makeAnagram("cdeabcg", "decabcg"));

    String s1 = "cdeabcg";
    String s2 = "decabcg";

    /** Make anagrams two strings */
    //    var x = Arrays.equals(
